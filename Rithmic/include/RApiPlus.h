...
#define API_ONM_ERROR         70

#define API_NUM_ERROR_CODES   71
...
class BarInfo
     ...
     int    iBuyerAsAggressorVolume;

     bool   bSellerAsAggressorVolume;
     int    iSellerAsAggressorVolume;
     ...
     int *    aiProfileNoAggressorVolumes;                  /* can be NULL   */
     int *    aiProfileBuyerAsAggressorVolumes;             /* can be NULL   */
     int *    aiProfileSellerAsAggressorVolumes;            /* can be NULL   */
...
class REngine
     ...
     int loginRepository(tsNCharcb *  pUser,
			 tsNCharcb *  pPassword,
			 tsNCharcb *  pCnnctPt,
			 RCallbacks * pCallbacks,
			 int *        aiCode);
